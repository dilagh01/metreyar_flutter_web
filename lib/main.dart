          ...
          Container(
            ...
            child: ListView(
              children: [
                ...
                // منوی ثانویه
                _buildSidebarItem(Icons.help, 'راهنما', 5),
                _buildSidebarItem(Icons.description, 'مستندات', 6),
              ],
            ),
          ),
      ...
      child: Column(
        ...
        children: [
          ...
          GridView.count(
            ...
            childAspectRatio: 2,
            children: [
              _buildInfoCard('پروژه‌های فعال', '12', Icons.folder, Colors.blue),
              _buildInfoCard('آیتم‌های متره', '347', Icons.list, Colors.green),
              _buildInfoCard('برآورد کل', '5.2B', Icons.attach_money, Colors.orange),
              _buildInfoCard('تسک‌های pending', '8', Icons.task, Colors.red),
            ],
          ),
